...
\begin{equation} \label{eq:proba2}
    \sigma_{p}^{\text{obs}} \text{\footnotemark} = \sqrt{\mathbb{E} \left[ \left( \frac{\text{HW}(X)}{n} - p^{\text{obs}} \right)^2 \right]} \approx 4.69 \times 10^{-3}
\end{equation}
