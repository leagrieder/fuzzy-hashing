...
\begin{equation}
    ...
    & \left. + 2\cdot\frac{2(2p - \delta)}{(2p + \delta)^3}\cdot\text{Cov}(B,C) \right]\\
    & \approx 0.01449 = 1.45\%
    \end{aligned}
    \label{eq:mu_indep}
\end{equation}\\
