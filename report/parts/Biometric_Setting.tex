...
The mean (\(p\)), along with the variance (\(\sigma²\)) and standard deviation (\(\sigma\)) of the random variable \(\left( \frac{\text{HW}(X)}{n} \right)\) across all images are quantified as follows:
