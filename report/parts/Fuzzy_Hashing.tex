...
\[
\mathbb{E}(f(A,B,C)) \approx \frac{p - \frac{\delta}{2}}{p + \frac{\delta}{2}} + \frac{1}{2} \left[ \frac{-4\delta}{(2p + \delta)^3}\cdot({\sigma^\text{obs}_p})^2 + \frac{-4\delta}{(2p + \delta)^3}\cdot({\sigma^\text{obs}_p})^2 + \frac{8p}{(2p + \delta)^3}\cdot({\sigma^\text{obs}_\delta})^2 
\right.
\]
\[
\left.
+ 2\cdot\frac{-4\delta}{(2p + \delta)^3}\cdot\text{Cov}(A,B) + 2\cdot\frac{2(2p - \delta)}{(2p + \delta)^3}\cdot\text{Cov}(A,C) + 2\cdot\frac{2(2p - \delta)}{(2p + \delta)^3}\cdot\text{Cov}(B,C) \right]
\]\\

In order to derive the respective covariances needed to calculate this expectation, we needed needed the 
