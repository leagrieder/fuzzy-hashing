...
\textbf{Summary of the FNR and FPR results obtained, using $l$ iterations of PreHash}
\begin{table}[htbp] 
    \centering
    \begin{tabular}{|c|c|c|c|c|c|c|}
        \hline
