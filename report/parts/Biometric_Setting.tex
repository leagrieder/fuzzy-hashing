...
\begin{itemize}
    ...
    \begin{equation*}
        \begin{aligned}
            P[\bar{X}_i = 0, \bar{Y}_i = 0] + P[\bar{X}_i = 0, \bar{Y}_i = 1] &= P[\bar{X}_i = 0 | \bar{Y}_i = 0]P[\bar{Y}_i = 0] \\
            &+ P[\bar{X}_i = 0 | \bar{Y}_i = 1]P[\bar{Y}_i = 1]\\
            &= P[\bar{X}_i = 0] = 1-p
        \end{aligned}
    \end{equation*} 
    \begin{equation*}
        \begin{aligned}
            P[\bar{X}_i = 0, \bar{Y}_i = 0] + P[\bar{X}_i = 1, \bar{Y}_i = 0] &= P[\bar{Y}_i = 0 | \bar{X}_i = 0]P[\bar{X}_i = 0] \\
            &+ P[\bar{Y}_i = 0 | \bar{X}_i = 1]P[\bar{X}_i = 1]\\
            &= P[\bar{Y}_i = 0] = 1-p
        \end{aligned}
    \end{equation*} 
