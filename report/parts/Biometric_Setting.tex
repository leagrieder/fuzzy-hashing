...
where \( \sigma \) and \( \sigma^2 \) represent the standard deviation and variance of the random variable \(\left( \frac{\text{HW}(X)}{n} \right)\) respectively.
