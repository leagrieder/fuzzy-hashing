...
%\Need to explain multiple things:
    %\Introduce the systems that are used nowadays for authentication and explain why it is preferrable to use biometric authentication systems and more precisely finger-vein authentication
...
%\Explain what we will be testing/implementing in this project without getting into too many details yet (we will get more in detail in the theoretical frmework where we explain what is in the fuzzy hash sections 1-5 and how we will test what is in there)
