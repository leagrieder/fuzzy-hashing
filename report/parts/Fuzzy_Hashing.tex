...
\[
    \mathbb{E}(A) = \mathbb{E}(B) = p^\text{obs}, \quad \mathbb{E}(C) = \delta^\text{obs}, \quad \text{Var}(A) = \text{Var}(B) = {\sigma^\text{obs}_p}^2, \quad \text{Var}(C) = {\sigma^\text{obs}_\delta}^2
\]
...
\]
\[
    \text{Var}(A) = \text{Var}(B) = \mathbb{E}((A - p)²), \quad \text{Var}(C) = \mathbb{E}((C - \delta)²)
\]
\[
...
And we hence have:
\[
    \mathbb{E}(f(A,B,C)) \approx \frac{p - \frac{\delta}{2}}{p + \frac{\delta}{2}} + \frac{1}{2} \left[ f''_{AA}(p,p,\delta)\text{Var}(A) + f''_{BB}(p,p,\delta)\text{Var}(B) + f''_{CC}(p,p,\delta)\text{Var}(C) \right.
\]
\[
+ 2f''_{AB}(p,p,\delta) \text{Cov}(A,B) + 2f''_{AC}(p,p,\delta) \text{Cov}(A,C) + 2f''_{BC}(p,p,\delta) \text{Cov}(B,C)]
\]\\
Let us denote that \(\mathcal{F}(p, \delta, \sigma_p, \sigma_\delta) = \mathbb{E}(f(A,B,C))\). Simplifying with our values and notations we get:
\[
    \mathcal{F}(p, \delta, \sigma_p, \sigma_\delta) \approx \frac{p - \frac{\delta}{2}}{p + \frac{\delta}{2}} + \frac{1}{2} \left[ \frac{-4\delta}{(2p + \delta)^3}\cdot{\sigma^\text{obs}_p}² + \frac{-4\delta}{(2p + \delta)^3}\cdot{\sigma^\text{obs}_p}² + \frac{8p}{(2p + \delta)^3}\cdot{\sigma^\text{obs}_\delta}² \right.
\]
\[
+ 2\cdot\frac{-4\delta}{(2p + \delta)^3}\cdot\text{Cov}(A,B) + 2\cdot\frac{2(2p - \delta)}{(2p + \delta)^3}\cdot\text{Cov}(A,C) + 2\cdot\frac{2(2p - \delta)}{(2p + \delta)^3}\cdot\text{Cov}(B,C)]
\]\\

Hence for (\(X\), \(Y\)) random,
\begin{equation}
    \label{eq:mu_leq}
    Pr[preHash_{key}^1(offset_X * X) = preHash_{key}^1(offset_Y * Y)] \leq \mathcal{F}(p, \delta, \sigma_p, \sigma_\delta)
\end{equation}
...
\begin{equation} \label{eq:mu}
    \mu = \mathcal{F}(p, \delta, \sigma_p, \sigma_\delta)
\end{equation}
...
The computation of \( \mu_{\text{indep}}^{obs} \) is relatively straightforward, having determined the value of \( p^{obs} \) and \(\delta_{\text{indep}}^{obs}\). The formula for \( \mu_{\text{indep}}^{obs} \) relies solely on \( p^{obs} \) and \(\delta_{\text{indep}}^{obs}\), allowing us to express it as:

\[
    \mu_{\text{indep}}^{obs} = \frac{p - \frac{\delta}{2}}{p + \frac{\delta}{2}} \approx 0.014 = 1.4\%
\]
...
\begin{enumerate}
    ...
    \begin{itemize}
        ...
        \[ \mu_{\text{same}}^{obs} \approx 0.23 = 23\%\]
        ...
        \[ \mu_{\text{diff}}^{obs} \approx 0.077 = 7.7\% \]
