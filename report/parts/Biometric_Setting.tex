...
% je crois pas en faite qu'on devrait avoir ca pour delta_indep... parce que delta_indep c'est quand X et Y n'ton pas de optimal offsets appliqueé Donc ca veut dire que X et Y sont indep et donc p(Xi = 0, Yi = 0) = P(Xi = 0)P(Yi = 0) = p²
PAS JUSTE?????!!!!
\begin{table}[H]
    \centering
    \renewcommand{\arraystretch}{1.5}
