...
\begin{enumerate}
    \item \textbf{m = 1, l = 217 and t = 32}
        \begin{itemize}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=\linewidth,height=10cm,keepaspectratio]{latex-img/FNR-FPR_ROC_TPR_config1a.png}
                \caption{ROC}
    ...
    \item \textbf{m = 1, l = 637 and t = 113}
        \begin{itemize}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=\linewidth,height=10cm,keepaspectratio]{latex-img/FNR-FPR_ROC_TPR_config1.png}
                \caption{ROC}
    ...
    \item \textbf{m = 2, l = 961 and t = 31}
        \begin{itemize}
            ...
            \begin{figure}[H]
                \centering
                \includegraphics[width=\linewidth,height=10cm,keepaspectratio]{latex-img/FNR-FPR_ROC_TPR_config2.png}
                \caption{ROC}
    ...
    \item \textbf{m = 3, l = 2569 and t = 15}
        \begin{itemize}
            ...
            \begin{figure}[H]
                    \centering
                    \includegraphics[width=\linewidth,height=10cm,keepaspectratio]{latex-img/FNR-FPR_ROC_TPR_config3.png}
                    \caption{ROC}
    ...
    \item \textbf{m = 4, l = 8481 and t = 10}
        \begin{itemize}
            ...
            %     \begin{minipage}[b]{0.48\linewidth}
            %         \centering
            %         \includegraphics[width=\linewidth,height=7cm,keepaspectratio]{latex-img/l-dHconfig4_same.png}
            ...
            %     \begin{minipage}[b]{0.48\linewidth}
            %         \centering
            %         \includegraphics[width=\linewidth,height=7cm,keepaspectratio]{latex-img/l-dHconfig4_diff.png}
...
From all figures from this subsection, we can deduce that the derived means of the distribution for same and different biometric samples are almost identical to the theoretical values predicted. Additionally, the variance of the distribution for different biometric samples are relatively close to the ones theoretically deduced. However, the variance of the distribution for same biometric samples do not correspond to the ones theoretically deduced. 
